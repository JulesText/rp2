...
class TestODSOutputDiff(AbstractTestODSOutputDiff):  # pylint: disable=too-many-public-methods
    ...
    def test_crypto_example_tax_report_au(self) -> None:
        for method in self.METHODS:
            self._compare(output_dir=self.output_dir, test_name="crypto_example", method=method, output_plugin=OutputPlugins.TAX_REPORT_AU)
    ...
    def test_test_data_tax_report_au(self) -> None:
        for method in self.METHODS:
            self._compare(output_dir=self.output_dir, test_name="test_data", method=method, output_plugin=OutputPlugins.TAX_REPORT_AU)
    ...
    def test_test_data2_tax_report_au(self) -> None:
        for method in self.METHODS:
            self._compare(output_dir=self.output_dir, test_name="test_data2", method=method, output_plugin=OutputPlugins.TAX_REPORT_AU)
    ...
    def test_test_data3_tax_report_au(self) -> None:
        for method in self.METHODS:
            self._compare(output_dir=self.output_dir, test_name="test_data3", method=method, output_plugin=OutputPlugins.TAX_REPORT_AU)
    ...
    def test_test_data4_tax_report_au(self) -> None:
        for method in self.METHODS:
            self._compare(output_dir=self.output_dir, test_name="test_data4", method=method, output_plugin=OutputPlugins.TAX_REPORT_AU)
    ...
    def test_test_hifo_tax_report_au(self) -> None:
        for method in self.METHODS:
            self._compare(output_dir=self.output_dir, test_name="test_hifo", method=method, output_plugin=OutputPlugins.TAX_REPORT_AU)
    ...
    def test_test_hifo2_tax_report_au(self) -> None:
        for method in self.METHODS:
            self._compare(output_dir=self.output_dir, test_name="test_hifo2", method=method, output_plugin=OutputPlugins.TAX_REPORT_AU)
    ...
    def test_test_many_year_data_tax_report_au(self) -> None:
        for method in self.METHODS:
            self._compare(output_dir=self.output_dir, test_name="test_many_year_data", method=method, output_plugin=OutputPlugins.TAX_REPORT_AU)
    ...
    def test_test_data3_tax_report_au_2019_12_01_2020_04_01(self) -> None:
        for method in self.METHODS:
            self._compare(
                output_dir=self.output_dir,
                test_name="test_data3",
                method=method,
                output_plugin=OutputPlugins.TAX_REPORT_AU,
                from_date=date(2019, 12, 1),
                to_date=date(2020, 4, 1),
            )
    ...
    def test_test_many_year_data_tax_report_au_0_2016(self) -> None:
        self._compare(
            output_dir=self.output_dir, test_name="test_many_year_data", method="fifo", output_plugin=OutputPlugins.TAX_REPORT_AU, to_date=date(2016, 12, 31)
        )
    ...
    def test_test_many_year_data_tax_report_au_0_2017(self) -> None:
        self._compare(
            output_dir=self.output_dir, test_name="test_many_year_data", method="fifo", output_plugin=OutputPlugins.TAX_REPORT_AU, to_date=date(2017, 12, 31)
        )
    ...
    def test_test_many_year_data_tax_report_a_0_2018(self) -> None:
        self._compare(
            output_dir=self.output_dir, test_name="test_many_year_data", method="fifo", output_plugin=OutputPlugins.TAX_REPORT_AU, to_date=date(2018, 12, 31)
        )
    ...
    def test_test_many_year_data_tax_report_au_0_2019(self) -> None:
        self._compare(
            output_dir=self.output_dir, test_name="test_many_year_data", method="fifo", output_plugin=OutputPlugins.TAX_REPORT_AU, to_date=date(2019, 12, 31)
        )
    ...
    def test_test_many_year_data_tax_report_au_0_2020(self) -> None:
        self._compare(
            output_dir=self.output_dir, test_name="test_many_year_data", method="fifo", output_plugin=OutputPlugins.TAX_REPORT_AU, to_date=date(2020, 12, 31)
        )
    ...
    def test_test_many_year_data_tax_report_au_2017_infinity(self) -> None:
        self._compare(
            output_dir=self.output_dir, test_name="test_many_year_data", method="fifo", output_plugin=OutputPlugins.TAX_REPORT_AU, from_date=date(2017, 1, 1)
        )
    ...
    def test_test_many_year_data_tax_report_au_2018_infinity(self) -> None:
        self._compare(
            output_dir=self.output_dir, test_name="test_many_year_data", method="fifo", output_plugin=OutputPlugins.TAX_REPORT_AU, from_date=date(2018, 1, 1)
        )
    ...
    def test_test_many_year_data_tax_report_au_2019_infinity(self) -> None:
        self._compare(
            output_dir=self.output_dir, test_name="test_many_year_data", method="fifo", output_plugin=OutputPlugins.TAX_REPORT_AU, from_date=date(2019, 1, 1)
        )
    ...
    def test_test_many_year_data_tax_report_au_2020_infinity(self) -> None:
        self._compare(
            output_dir=self.output_dir, test_name="test_many_year_data", method="fifo", output_plugin=OutputPlugins.TAX_REPORT_AU, from_date=date(2020, 1, 1)
        )
    ...
    def test_test_many_year_data_tax_report_au_2021_infinity(self) -> None:
        self._compare(
            output_dir=self.output_dir, test_name="test_many_year_data", method="fifo", output_plugin=OutputPlugins.TAX_REPORT_AU, from_date=date(2021, 1, 1)
        )
    ...
    def test_test_many_year_data_tax_report_au_2017_2019(self) -> None:
        self._compare(
            output_dir=self.output_dir,
            test_name="test_many_year_data",
            method="fifo",
    ...
    def test_test_many_year_data_tax_report_au_2018_2019(self) -> None:
        self._compare(
            output_dir=self.output_dir,
            test_name="test_many_year_data",
            method="fifo",
    ...
    def test_test_many_year_data_tax_report_au_2019_2019(self) -> None:
        self._compare(
            output_dir=self.output_dir,
            test_name="test_many_year_data",
            method="fifo",
    ...
    def test_test_data_multi_method_tax_report_au(self) -> None:
        self._compare(
            output_dir=self.output_dir,
            test_name="test_data_multi_method",
            method="mixed",
